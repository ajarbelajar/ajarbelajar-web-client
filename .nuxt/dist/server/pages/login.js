...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/login.vue?vue&type=template&id=309a2843&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.submit(_vm.form)}}},[_vm._ssrNode("<h1 class=\"mt-14 mb-8 text-4xl font-light text-center text-gray-700\">\n    Masuk ke akun anda\n  </h1> "+((!!_vm.errors.message)?("<div class=\"flex relative items-center p-4 mb-5 bg-red-50 rounded border-l-4 border-red-500 shadow-sm\"><div class=\"flex-grow text-red-700\">"+_vm._ssrEscape(_vm._s(_vm.errors.message))+"</div></div>"):"<!---->")+" "),_c('form-input',{attrs:{"placeholder":"Email atau Username","name":"identity","error":_vm.errors.identity || _vm.errors.email || _vm.errors.username},model:{value:(_vm.form.identity),callback:function ($$v) {_vm.$set(_vm.form, "identity", $$v)},expression:"form.identity"}}),_vm._ssrNode(" "),_c('form-input',{attrs:{"placeholder":"Password","password":"","name":"password","error":_vm.errors.password},model:{value:(_vm.form.password),callback:function ($$v) {_vm.$set(_vm.form, "password", $$v)},expression:"form.password"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"py-3 text-center\">","</div>",[_c('form-button',{staticClass:"block w-6/12 uppercase",attrs:{"loading":_vm.loading}},[_vm._v("Masuk")])],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"text-center\">","</div>",[_c('nuxt-link',{staticClass:"hover:text-primary-700 text-primary-600 font-semibold",attrs:{"to":"/password/forget"}},[_vm._v("Lupa Password?")])],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/login.vue?vue&type=template&id=309a2843&
