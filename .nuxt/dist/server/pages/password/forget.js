...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/password/forget.vue?vue&type=template&id=697add7b&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.submit(_vm.form)}}},[_vm._ssrNode("<h1 class=\"mt-14 mb-8 text-4xl font-light text-center text-gray-700\">\n    Lupa Password\n  </h1> "+((!!_vm.errors.message)?("<div class=\"flex relative items-center p-4 mb-5 bg-red-50 rounded border-l-4 border-red-500 shadow-sm\"><div class=\"flex-grow text-red-700\">"+_vm._ssrEscape(_vm._s(_vm.errors.message))+"</div></div>"):"<!---->")+" "+((!!_vm.success)?("<div class=\"bg-primary-50 border-primary-500 flex relative items-center p-4 mb-5 rounded border-l-4 shadow-sm\"><div class=\"text-primary-700 flex-grow\">"+_vm._ssrEscape(_vm._s(_vm.success))+"</div></div>"):"<!---->")+" "),_c('form-input',{attrs:{"placeholder":"Email","name":"email","error":_vm.errors.email},model:{value:(_vm.form.email),callback:function ($$v) {_vm.$set(_vm.form, "email", $$v)},expression:"form.email"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"py-3 text-center\">","</div>",[_c('form-button',{staticClass:"block w-6/12 uppercase",attrs:{"loading":_vm.loading}},[_vm._v("\n      Kirim\n    ")])],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"text-center\">","</div>",[_c('nuxt-link',{staticClass:"hover:text-primary-700 text-primary-600 font-semibold",attrs:{"to":"/login"}},[_vm._v("Masuk")])],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/password/forget.vue?vue&type=template&id=697add7b&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/password/forget.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/password/forget.vue?vue&type=script&lang=js&
 /* harmony default export */ var password_forgetvue_type_script_lang_js_ = (forgetvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/password/forget.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  password_forgetvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
