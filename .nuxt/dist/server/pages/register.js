...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/register.vue?vue&type=template&id=55dafe4e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.submit(_vm.form)}}},[_vm._ssrNode("<h1 class=\"mt-14 mb-8 text-4xl font-light text-center text-gray-700\">\n    Buat akun baru\n  </h1> "+((!!_vm.errors.message)?("<div class=\"flex relative items-center p-4 mb-5 bg-red-50 rounded border-l-4 border-red-500 shadow-sm\"><div class=\"flex-grow text-red-700\">"+_vm._ssrEscape(_vm._s(_vm.errors.message))+"</div></div>"):"<!---->")+" "),_c('form-input',{attrs:{"placeholder":"Nama","name":"name","error":_vm.errors.name},model:{value:(_vm.form.name),callback:function ($$v) {_vm.$set(_vm.form, "name", $$v)},expression:"form.name"}}),_vm._ssrNode(" "),_c('form-input',{attrs:{"placeholder":"Username","name":"username","error":_vm.errors.username},model:{value:(_vm.form.username),callback:function ($$v) {_vm.$set(_vm.form, "username", $$v)},expression:"form.username"}}),_vm._ssrNode(" "),_c('form-input',{attrs:{"placeholder":"Email","name":"email","error":_vm.errors.email},model:{value:(_vm.form.email),callback:function ($$v) {_vm.$set(_vm.form, "email", $$v)},expression:"form.email"}}),_vm._ssrNode(" "),_c('form-input',{attrs:{"placeholder":"Password","password":"","name":"password","error":_vm.errors.password},model:{value:(_vm.form.password),callback:function ($$v) {_vm.$set(_vm.form, "password", $$v)},expression:"form.password"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"py-3 text-center\">","</div>",[_c('form-button',{staticClass:"block w-6/12 uppercase",attrs:{"loading":_vm.loading}},[_vm._v("Daftar")])],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/register.vue?vue&type=template&id=55dafe4e&
