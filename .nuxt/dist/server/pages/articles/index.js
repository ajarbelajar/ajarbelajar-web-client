...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/articles/index.vue?vue&type=template&id=dd1a588e&
...
// CONCATENATED MODULE: ./pages/articles/index.vue?vue&type=template&id=dd1a588e&
...
/* harmony default export */ var articlesvue_type_script_lang_js_ = ({
  ...
  methods: {
    infiniteHandler($state) {
      this.$axios.$get(`/articles?page=${this.meta ? this.meta.current_page + 1 : 1}`).then(({
        data,
        meta,
        links
      }) => {
