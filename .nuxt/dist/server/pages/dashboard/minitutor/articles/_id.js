exports.ids = [50,5,14,21,22,23,25,37];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dashboard/minitutor/articles/_id.vue?vue&type=template&id=76135f2c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"p-3"},[_vm._ssrNode("<form class=\"grid relative md:grid-cols-3 md:gap-4\">","</form>",[_vm._ssrNode("<div class=\"order-last md:order-1 md:col-span-2\">","</div>",[_vm._ssrNode("<div class=\"bg-white rounded shadow\" style=\"min-height: 300px\">","</div>",[_vm._ssrNode("<div class=\"py-4 px-3 border-b\"><h3 class=\"font-semibold leading-none\">Kontent</h3></div> "),_vm._ssrNode("<div class=\"p-3\">","</div>",[_c('client-only',[_c('editorjs',{attrs:{"upload-url":("/minitutor/request-articles/" + (_vm.post.id) + "/image")},model:{value:(_vm.form.body),callback:function ($$v) {_vm.$set(_vm.form, "body", $$v)},expression:"form.body"}})],1)],1)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"order-2\">","</div>",[_vm._ssrNode("<div class=\"mb-3 bg-white rounded shadow\">","</div>",[_vm._ssrNode("<div class=\"py-4 px-3 border-b\"><h3 class=\"font-semibold leading-none\">Cover</h3></div> "),_c('elements-hero-uploader',{attrs:{"hero":_vm.post.hero,"pid":_vm.post.id,"type":"Article"},on:{"updated":_vm.onHeroUpdated}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mb-3 bg-white rounded shadow\">","</div>",[_vm._ssrNode("<div class=\"py-4 px-3 border-b\"><h3 class=\"font-semibold leading-none\">Informasi</h3></div> "),_vm._ssrNode("<div class=\"p-3\">","</div>",[_vm._ssrNode("<div class=\"block\">","</div>",[_vm._ssrNode("<p class=\"text-sm\">Kategori</p> "),_c('form-category-suggest',{attrs:{"minimal":"","error":_vm.errors.category},model:{value:(_vm.form.category),callback:function ($$v) {_vm.$set(_vm.form, "category", $$v)},expression:"form.category"}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"block\">","</div>",[_vm._ssrNode("<p class=\"text-sm\">Judul</p> "),_c('form-input',{attrs:{"minimal":"","error":_vm.errors.title},model:{value:(_vm.form.title),callback:function ($$v) {_vm.$set(_vm.form, "title", $$v)},expression:"form.title"}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"block\">","</div>",[_vm._ssrNode("<p class=\"text-sm\">Deskripsi</p> "),_c('form-textarea',{attrs:{"minimal":"","error":_vm.errors.description},model:{value:(_vm.form.description),callback:function ($$v) {_vm.$set(_vm.form, "description", $$v)},expression:"form.description"}})],2),_vm._ssrNode(" <div class=\"block\"><label class=\"block py-2 text-sm text-gray-600\"><input type=\"checkbox\""+(_vm._ssrAttr("checked",Array.isArray(_vm.form.requested)?_vm._i(_vm.form.requested,null)>-1:(_vm.form.requested)))+" class=\"rounded border-gray-300\">\n              Publikasikan artikel ini\n            </label></div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex p-3 border-t\">","</div>",[_c('form-button',{staticClass:"block w-24",attrs:{"loading":_vm.loading}},[_vm._v("Simpan")]),_vm._ssrNode(" "),_c('form-button',{staticClass:"block ml-3 w-24",attrs:{"light":"","tag":"nuxt-link","to":"."}},[_vm._v("Kembali")])],2)],2)],2)],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/dashboard/minitutor/articles/_id.vue?vue&type=template&id=76135f2c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dashboard/minitutor/articles/_id.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/dashboard/minitutor/articles/_id.vue?vue&type=script&lang=js&
 /* harmony default export */ var articles_idvue_type_script_lang_js_ = (_idvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/dashboard/minitutor/articles/_id.vue
...
installComponents(component, {ElementsHeroUploader: __webpack_require__(98).default,FormCategorySuggest: __webpack_require__(99).default,FormInput: __webpack_require__(78).default,FormTextarea: __webpack_require__(79).default,FormButton: __webpack_require__(76).default})
