      ...
      <div class="mb-3 rounded-lg border">
        ...
        <div class="p-3">
          <div class="block">
            ...
            <form-category-suggest v-model="form.category" minimal />
          </div>
          <div class="block">
            <p class="text-sm">Judul</p>
            <form-input v-model="form.title" minimal />
          </div>
          <div class="block">
            <p class="text-sm">Deskripsi</p>
            <form-textarea v-model="form.description" minimal />
          </div>
          <div class="block">
        ...
        <div class="flex p-3 border-t">
          ...
          <form-button light tag="nuxt-link" to="." class="block ml-3 w-24" :loading="loading">Kembali</form-button>
        </div>
      </div>
    </div>
  </form>
