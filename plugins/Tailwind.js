...
import { TAlert, TButton } from 'vue-tailwind/dist/components';
  ...
  't-alert': {
    ...
    props: {
      fixedClasses: {
        ...
        body: 'flex-grow',
        close: 'absolute relative flex items-center justify-center ml-4 flex-shrink-0 w-6 h-6 transition duration-100 ease-in-out rounded  focus:ring-2 focus:ring-primary-500 focus:outline-none focus:ring-opacity-50',
